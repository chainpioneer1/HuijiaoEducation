...
var exitPageStatus;
var iServerStart = 0;
var bLMSresult = "false";

function loadPage()
{
   bLMSresult = doLMSInitialize();     
   var status = doLMSGetValue( "cmi.core.lesson_status" );
   iServerStart = doLMSGetValue("cmi.core.lesson_location");		
	...
	if (exitPageStatus != true)
	{
		var status = doLMSGetValue("cmi.core.lesson_status");
   		if (status == "incomplete") 
		    // if status is "passed" or "failed", we should not set "completed" status
