...
function showContentPlayer(id,isPopup) {
    ...
    if (isPopup == undefined) isPopup = false;
    if (isPopup) {
        var win = window.open(baseURL + "resource/warePreviewPlayer/" + id, '_blank');
        win.focus();
    } else
        location.href = baseURL + "resource/warePreviewPlayer/" + id;
...
function showLessonPlayer(id,isPopup) {
    ...
    if (isPopup == undefined) isPopup = false;
    if (isPopup) {
        var win = window.open(baseURL + "resource/previewPlayer/" + id, '_blank');
        win.focus();
    } else
        location.href = baseURL + "resource/previewPlayer/" + id;
