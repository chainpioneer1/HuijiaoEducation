    ...
    public function output_content($items)
    {
        ...
        foreach ($items as $unit):
            ...
            $output .= '<button style="width:70px;" '
                ...
                . ' data-code = "' . $unit->auth_code . '" '
                . ' data-token = "' . $unit->access_token . '" '
...
//                . $btn_str[2] . '</button>';
            $output .= '<button style="width:70px;"'
                . ' class="btn btn-sm ' . ($unit->admin_id != 1 && ($isAdmin || $Editable) ? 'btn-danger' : 'disabled') . '"'
                . ' onclick = "' . ($unit->admin_id != 1 && ($isAdmin || $Editable) ? 'deleteItem(this);' : '') . '"'
                . ' data-id = "' . $unit->admin_id . '">'
                . $btn_str[4] . '</button>';
            $output .= '<button style="width:70px;"'
