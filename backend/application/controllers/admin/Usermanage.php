...
class Usermanage extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['items'] = $this->activationcodes_m->getItems();
        $this->data['user_areas'] = $this->activationcodes_m->getAreas();
        $this->data['user_class'] = $this->activationcodes_m->getSchools();
    ...
    {
        $users = $this->activationcodes_m->getUnusedItems();
    }
...
//                        continue;
    ...
    public function update_user()
    {
        ...
        if ($_POST) {
            ...
            if ($arr['password'] == '') {
                ...
                $arr['password'] = $this->activationcodes_m->hash($arr['password']);
            }
            $result = $this->activationcodes_m->edit($arr, $user_id);
    ...
    public function delete_user()
    {
        ...
        if ($_POST) {
            $arr = [];
            $user_id = $_POST['user_id'];
            $result = $this->activationcodes_m->deleteItem($user_id);
