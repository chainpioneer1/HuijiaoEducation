...
//        if (!strlen($this->db->order_by($this->_order_by))) {
...
//        }
    ...
    function get_where($array = NULL, $subCondition = NULL)
    {
...
//        }
    ...
    function get_where_in($key, $array = NULL)
    {
    ...
    public function fetch_limit($limit, $start)
    {
