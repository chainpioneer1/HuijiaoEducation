            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="table-toolbar">
                        ...
                        <div class="row">
                            <form class="form-horizontal col-md-6" action="<?= base_url($ctrlRoot . '/index') ?>"
            ...
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-4 control-label"
                           style="text-align:center;">编码:</label>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label"
                           style="text-align:center;">位置序号:</label>
                    <div class="col-md-7" style="padding-left: 0">
                        <input type="text" class="form-control" name="sort_order" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="cwImageUpload" class=" col-md-4 control-label" style="text-align: center;">Banner图:</label>
                    <div class="col-md-7" style="padding-left: 0;">
                ...
                <div class="form-group" style="display: none;">
                    <label for="cwImageUpload" class=" col-md-4 control-label" style="text-align: center;">移动端图:</label>
                    <div class="col-md-7" style="padding-left: 0;">
                        <div class="fileinput fileinput-new" data-provides="fileinput"
                             style="background-color: #e0e1e1;position: relative">
                                <span class="btn btn-default btn-file">
...
<div class="scripts" hidden style="display: none;">
    <script>
        $(function () {
            $('a.nav-link[menu_id="113"]').addClass('menu-selected');
        })
