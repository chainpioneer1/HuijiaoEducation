<?php
$ctrlRoot = 'admin/coursetypes';
$category = '课程';
$mainModel = 'tbl_huijiao_course_type';
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="btn-group right-floated">
                                    <button class=" btn btn-default" onclick="publishItem(this)" data-id="-1" data-status="0">
                                        <i class="fa fa-save"></i>&nbsp全部启用
                                    </button>
                                </div>
                                <div class="btn-group right-floated" style="margin-right: 30px;">
                                    <button class=" btn btn-warning" onclick="publishItem(this)" data-id="-2" data-status="1">
        ...
        <form class="form-horizontal" action="" id="add-submit-form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="form-group" style="display: none!important;">
                        <label for="cwImageUpload" class=" col-md-4 control-label" style="text-align: center;">PC端封面图:</label>
                    <div class="col-md-7" style="padding-left: 0;">
...
<div class="scripts" hidden style="display: none;">
    ...
    <script>
        $(function () {
            $('a.nav-link[menu_id="02"]').addClass('menu-selected');
            searchConfig();
        })
...
//                    if (item.status == '0') continue;
            ...
            if (filterInfo[_mainObj + '.coruse_no']) $('input[name="search_no"]').val(filterInfo[_mainObj + '.course_no']);
            ...
            if (filterInfo[_mainObj + '.term_id']) $('select[name="search_term"]').val(filterInfo[_mainObj + '.term_id']);
        }
