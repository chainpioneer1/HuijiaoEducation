<?php
$ctrlRoot = 'admin/users/school_info';
$category = '学校';
$mainModel = 'tbl_user';
?>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="table-toolbar">
                        ...
                        <div class="row">
                            <form class="form-horizontal col-md-10" action="<?= base_url($ctrlRoot . '') ?>"
                                  id="searchForm" role="form" method="post" enctype="multipart/form-data"
                                  accept-charset="utf-8">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="col-md-5 control-label">学校名称:</label>
                                            <div class="col-md-7">
...
<div class="scripts" hidden style="display: none;">
    <input hidden class="subjectList" value='[]'>
    <input hidden class="termList" value='[]'>
    <input hidden class="userTypeList" value='[]'>
    <input hidden class="filterInfo"
           value='<?= json_encode($this->session->userdata('filter') ? $this->session->userdata('filter') : array()) ?>'>
    <script>
        $(function () {
            $('a.nav-link[menu_id="54"]').addClass('menu-selected');
            searchConfig();
        });
...
//                if (item.status == '0') continue;
            ...
            if (filterInfo[_mainObj + '.user_school']) $('input[name="search_no"]').val(filterInfo[_mainObj + '.user_school']);
            if (filterInfo[_mainObj + '.user_info']) $('input[name="search_title"]').val(filterInfo[_mainObj + '.user_info']);
