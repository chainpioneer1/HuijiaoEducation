        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="usage-tab-item" data-id="7">统计总结</div>
                ...
                <div class="portlet light bordered" data-id="4">
                    <div class="portlet-body">
                        <div class="main-frame" data-id="7">
                            <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body">
                        ...
                        <div class="main-frame body" data-id="6">
                            <div class="frame-responsive-container">
                        ...
                        <div class="main-frame body" data-id="7">
                            <div class="frame-responsive-container">
                                <div class="frame-title">平台登录使用统计</div>
                                <div class="canvas-container">
                                    <canvas id="chart-area-platform"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="main-frame body" data-id="5"></div>
                        ...
                        <div class="main-frame" data-id="2">
                            <div class="frame-third-container">
                                <div class="frame-title">资源浏览比例图</div>
                                <div class="canvas-container">
                                    <canvas id="chart-area-subjects-content"></canvas>
                                </div>
                            </div>
                            <div class="frame-third-container">
                                <div class="frame-title">课件浏览比例图</div>
                                <div class="canvas-container">
                                    <canvas id="chart-area-subjects-lesson"></canvas>
                                </div>
                            </div>
                            <div class="frame-third-container">
                                <div class="frame-title">浏览总比例图</div>
                                <div class="canvas-container">
                                    <canvas id="chart-area-subjects-total"></canvas>
                                </div>
                            </div>
                        </div>
    ...
    <div class="scripts" hidden style="display: none;">
        ...
        <script>
                ...
                $('.usage-tab-item').on('click', function (object) {
                    ...
                    switch (menu_id) {
                        ...
                        case '4': // 按科目统计
                            $('.portlet[data-id="4"]').hide();
                            $('.portlet[data-id="1"]').show();
                            $('.portlet[data-id="1"] .table-toolbar').show();
                        ...
                        case '5': // 按类型统计
                            ...
                            for (var s = 0; s < subjectList.length; s++) {
                                ...
                                content_html += '<div class="frame-responsive-container">';
                                content_html += '<div class="frame-title">' + sItem.title;
                                var termTmp = termList.filter(function (a) {
                                    return a.subject_id == sItem.id;
                                });
                                content_html += '<select class="frame-term" data-id="' + sItem.id + '" style="float: right;font-size: 14px;margin-right: 40px;">' +
                        ...
                        case '7': // 统计总结
                            ...
                            $('.portlet[data-id="1"] .table-toolbar').show();
                            $('.main-frame').hide();
                            $('.portlet-body .main-frame[data-id="' + menu_id + '"]').show();
            ...
            function drawSummary() {
                $('.main-frame.body[data-id="7"]').show();
                ...
                var start = makeDateString(new Date(now.setMonth(now.getMonth() - 1)));
                ...
                var titleInfo = ['PC端Web', '移动端Web', '安卓版APP', 'iOS版APP'];
                var chartInfo = [0, 0, 0, 0];
                ...
                for (var i = 0; i <= diff; i++) {
                    ...
                    if (today_action.length > 0) {
                        chartInfo[0] += today_action[0].login_pcweb * 1;
                        chartInfo[1] += today_action[0].login_mweb * 1;
                        chartInfo[2] += today_action[0].login_android * 1;
                        chartInfo[3] += today_action[0].login_ios * 1;
                    }
                        ...
                        tooltips: {
                            callbacks: {
                                label: function (tooltipItem, data) {
                                    ...
                                    return data.labels[tooltipItem.index] + ": " + precentage + "%(" + currentValue + "次)";
                                }
                            }
                        }
                    }
                ...
                var ctx = document.getElementById('chart-area-platform').getContext('2d');
            ...
            function drawTermsDetail() {
                ...
                var colorInfo = ['#2ea8ff', '#ff852e', '#b39aff', '#45ff2e',
                    '#2effbb', '#2ee2ff', '#ffd22e',
                    '#d89aff', '#e0d6ff', '#dddddd'];
            ...
            function drawContentTypeDetail(sId) {
                ...
                for (var i = 0; i < subjectList.length; i++) {
                    ...
                    contentTypeData = contentTypeData.sort(function (a, b) {
                        return (a.contenttype_id > b.contenttype_id) ? 1 : -1;
                    })
                    ...
                    contentTypeIds = removeDuplicated(contentTypeIds);
                    var datasets = [];
...
//                type: 'pie',
            ...
            function drawSubjectsInfo() {
                ...
                var keys = ['total_read', 'total_favorite', 'total_like', 'total_download'];
                var titles = ['浏览', '收藏', '点赞', '下载'];
                var content_html = '';
                for (var i = 0; i < titles.length; i++) {
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">科目资源' + titles[i] + '量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-subjects-content' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">科目课件' + titles[i] + '量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-subjects-lesson' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">各科目' + titles[i] + '总量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-subjects-total' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                }
                $('.main-frame[data-id="2"]').html(content_html);
                subjectsContentInfo = subjectsContentInfo.sort(function (a, b) {
                    return (a.title < b.title) ? 1 : -1
                });
                subjectsLessonInfo = subjectsLessonInfo.sort(function (a, b) {
                    return (a.title < b.title) ? 1 : -1
                });
                for (var xx = 0; xx < keys.length; xx++) {
                    ...
                    for (var i = 0; i < subjectsContentInfo.length; i++) {
                        chartInfo.push(subjectsContentInfo[i][key]);
                    ...
                    var ctx = document.getElementById('chart-area-subjects-content' + xx).getContext('2d');
                    window.myPie1 = new Chart(ctx, config);

                    chartInfo = [];
                    titleInfo = [];
                    for (var i = 0; i < subjectsLessonInfo.length; i++) {
                        chartInfo.push(subjectsLessonInfo[i][key]);
                    ...
                    var ctx = document.getElementById('chart-area-subjects-lesson' + xx).getContext('2d');
                    window.myPie1 = new Chart(ctx, config);
                    ...
                    for (var i = 0; i < subjectsLessonInfo.length; i++) {
                        var subjectContentItem = subjectsContentInfo.filter(function (a) {
                            return a.title == subjectsLessonInfo[i].title;
                        })
                        var usage = 0;
                        if (subjectContentItem.length > 0) usage = subjectContentItem[0][key];
                        chartInfo.push(subjectsLessonInfo[i][key] * 1 + usage * 1);
                        titleInfo.push(subjectsLessonInfo[i].title);
                    }
                    var config = {
                        type: 'pie',
                    ...
                    var ctx = document.getElementById('chart-area-subjects-total' + xx).getContext('2d');
                    window.myPie1 = new Chart(ctx, config);
                }
            }
            ...
            function drawTermsInfo() {
                ...
                for (var i = 0; i < titles.length; i++) {
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">年级资源' + titles[i] + '量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-terms-content' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">年级课件' + titles[i] + '量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-terms-lesson' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                    content_html += '<div class="frame-third-container">' +
                        '<div class="frame-title">各年级' + titles[i] + '总量比例图</div>' +
                        '<div class="canvas-container">' +
                        '<canvas id="chart-area-terms-total' + i + '"></canvas>' +
                        '</div>' +
                        '</div>';
                }
                $('.main-frame[data-id="3"]').html(content_html);


                termsContentInfo = termsContentInfo.sort(function (a, b) {
                    return (a.title < b.title) ? 1 : -1
                });
                termsLessonInfo = termsLessonInfo.sort(function (a, b) {
                    return (a.title < b.title) ? 1 : -1
                });
                for (var xx = 0; xx < keys.length; xx++) {
                    var chartInfo = [];
                    ...
                    for (var i = 0; i < termsContentInfo.length; i++) {
                        chartInfo.push(termsContentInfo[i][key]);
                    ...
                    var ctx = document.getElementById('chart-area-terms-content' + xx).getContext('2d');
                    window.myPie2 = new Chart(ctx, config);

                    chartInfo = [];
                    titleInfo = [];
                    for (var i = 0; i < termsLessonInfo.length; i++) {
                        chartInfo.push(termsLessonInfo[i][key]);
                    ...
                    var ctx = document.getElementById('chart-area-terms-lesson' + xx).getContext('2d');
                    window.myPie2 = new Chart(ctx, config);

                    chartInfo = [];
                    titleInfo = [];
                    for (var i = 0; i < termsContentInfo.length; i++) {
                        var termLessonItem = termsLessonInfo.filter(function (a) {
                            return a.title.substr(0, 3) == termsContentInfo[i].title.substr(0, 3);
                        })
                        var usage = 0;
                        if (termLessonItem.length > 0) usage = termLessonItem[0][key];
                        chartInfo.push(termsContentInfo[i][key] * 1 + usage * 1);
                        titleInfo.push(termsContentInfo[i].title.substr(0, 3));
                    }
                    var config = {
                        type: 'pie',
                    ...
                    var ctx = document.getElementById('chart-area-terms-total' + xx).getContext('2d');
                    window.myPie2 = new Chart(ctx, config);
                }
            }
