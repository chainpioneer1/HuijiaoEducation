            ...
            <div class="form-body">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-md-7" style="padding-left: 0">
                            <input type="text" class="item-select form-control" name="title" value="">
                        </div>
                    </div>
                    <div class="form-group col-md-2">
                        <label class="col-md-12 control-label"
                               style="text-align:left;">封面图:</label>
                        <div>
                    ...
                    <div class="form-group col-md-5">
                        <label class="col-md-4 control-label"
                               style="text-align:left;">本课资源:</label>
                        <div class="col-md-7" style="padding-left:0;">
                            <div class="content-items" data-type="contents" style="height: 300px;"></div>
...
//                    if (item.status == '0') continue;
        ...
        $("#add-submit-form").submit(function (e) {
            e.preventDefault();
            preparePreview();
            var termId = $('select[name="term_id"]').val();
            var title = $('input.item-select').val();
            if (!title) {
                alert('请输入新建课件名称');
                return;
