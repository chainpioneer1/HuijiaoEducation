        ...
        <form class="form-horizontal" action="" id="add-submit-form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-md-12">
                        <label class="col-md-4 control-label" style="text-align: center;">资源名称:</label>
                        <div class="col-md-7" style="padding-left:0;">
...
<div class="scripts" hidden style="display: none;">
    ...
    <script>
        $(function () {
            $('a.nav-link[menu_id="14"]').addClass('menu-selected');
            searchConfig();
            controlConfig();
        });
...
//                    tbody.innerHTML = res.data;
        ...
        function addItem(self) {
            ...
            $('select[name="content_id"]').on('change input', function () {
                ...
                // var image_corner_m = '';
                // if (contentItem.length != 0) {
                //     image_icon_m = contentItem[0].icon_path_m;
                //     image_corner_m = contentItem[0].icon_corner_m;
                // }
                // bgStr = '';
                ...
                // }
                // if (bgStr != '') $('div .img_preview[item_type=5]').css({background: bgStr});
...
//                    if (item.status == '0') continue;
        ...
        function makeContentList(coursetype_id, type, content_id) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status == true) {
                        ...
                        var tag = $('.content-items[data-type="' + type + '"]');
                        tag.html(content_html);
                        if (content_id) tag.val(content_id);
                        tag.trigger('change');
                    } else { //failed
                        alert("操作失败");
                    }
