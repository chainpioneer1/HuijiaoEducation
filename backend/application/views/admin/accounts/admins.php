...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <h1 class="page-title"><?= $category ?>管理
            <small></small>
        </h1>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                <div class="btn-group right-floated">
                                    <button class=" btn blue" id="add_new_admin_btn"><i
                                                class="fa fa-plus"></i>&nbsp;新增<?= $category ?>
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="add_admin_submit_form" role="form"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label"
                           style="text-align:center;"><?php echo $this->lang->line('role_confirm_pwd_modal'); ?>
                        :</label>
                    <div class="col-md-7" style="padding-left: 0">
...
<div id="assign_admin_modal" class="modal fade" tabindex="-1" data-width="700">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title"><?php echo $this->lang->line('assign_permission'); ?></h4>
    </div>
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="assign_admin_submit_form"
              role="form"
              method="post" accept-charset="utf-8">
            <div class="form-body">
                <div class="form-group">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <label class="col-md-7 control-label" id="edit_admin_fullname"
                           style="text-align:left;font-weight:bold;"><?php echo $this->lang->line('account'); ?>
                        :</label>
                </div>
...
//                executionPageNation();
    ...
    $("#add_admin_submit_form").submit(function (e) {
        ...
        fdata.append("permission", JSON.stringify(makeJsonArr()));
        e.preventDefault();
        $.ajax({
